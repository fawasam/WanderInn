...
// Send email to verify register
const sendEmailRegister = (username, to, url, text) => {
  ...
  //        <a href="http://your-frontend-url/email-verify/${emailVerificationToken}">Verify Email</a>
