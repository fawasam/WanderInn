...
const Header = () => {
  ...
  return (
    <header className=" flex justify-between md:px-20 px-2">
      {/* header logo start  */}
      <Link to={"/"} className="flex items-center gap-1">
        ...
        <span className="font-bold text-xl">Wanderlnn</span>
      </Link>
      {/* header logo end  */}
      {/* header search widget start  */}
      ...
      {/* header search widget end  */}
      {/* header user widget start  */}
      <Link
